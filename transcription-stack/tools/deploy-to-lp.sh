...
ssh "$HOST" '
  chmod +x ~/.local/bin/local-live-dictation.py ~/.local/bin/local-live-dictation-eval.py ~/.local/bin/local-live-dictation-waybar-status.py ~/.local/bin/hyprwhspr-double-left-ctrl.py
  python3 -m py_compile ~/.local/bin/local-live-dictation.py ~/.local/bin/local-live-dictation-eval.py ~/.local/bin/local-live-dictation-waybar-status.py ~/.local/bin/hyprwhspr-double-left-ctrl.py
